...
public class Template_2Controller {
    ...
    @GetMapping("/temp_2")
    public ResponseEntity<List<Template_2Dto>> getTemp_2(@RequestParam(name = "rowCode", required = false) String rowCode,
        ...
        return ResponseEntity.ok(template_2Service.getTemp_2(rowCode, colCode, rowNm, dt));
    }
}
